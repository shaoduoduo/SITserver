...
set(Qt5Mqtt_VERSION_STRING 5.11.0)
...
if (NOT TARGET Qt5::Mqtt)
    ...
    set(Qt5Mqtt_PRIVATE_INCLUDE_DIRS
        "${_qt5Mqtt_install_prefix}/include/QtMqtt/5.11.0"
        "${_qt5Mqtt_install_prefix}/include/QtMqtt/5.11.0/QtMqtt"
    )
    ...
    foreach(_module_dep ${_Qt5Mqtt_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.11.0 ${_Qt5Mqtt_FIND_VERSION_EXACT}
    ...
    _populate_Mqtt_target_properties(RELEASE "libQt5Mqtt.so.5.11.0" "" )
